...
/**
 * use okhttp3.11.0 implements, because of un-allowed non-Ascii characters in the Heades.of() method
 * of okhttp3.12.0, which influence the form upload so that it couldn't use the Chinese filename.
 */
...
public final class MultipartBody extends RequestBody {
    ...
    MultipartBody(ByteString boundary, MediaType type, List<Part> parts) {
        ...
        this.parts = Util.toImmutableList(parts);
    }
